class firstRound extends Phaser.Scene{
    constructor(){
        super("firstRoundScene");
        this.my = {sprite: {}};
    ...
    preload(){
        ...
        this.load.audio("playerhit", "laserLarge_004.ogg");


        document.getElementById('description').innerHTML = '<h2>Wave One</h2>';
    ...
    update(){
        ...
        if (this.gameStart){
            if (my.sprite.enemies.length < this.maxEnemies){
                my.sprite.enemies.push(this.add.sprite(this.enemyX + this.enemyOffset, this.enemyY, "enemy"));
        ...
        if (this.enemycount == 0){
            this.score
            this.scene.start("secondRoundScene");
        }
